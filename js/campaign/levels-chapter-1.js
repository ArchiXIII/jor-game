(function () {
  ...
  const levels = [
    ...
    { ...common, n: 2, type: 'growth', target: 2, stars: [2, 2, 2], starMode: 'completionTime', timeStars: [80, 60, 45], timeLimit: 80, finishDelayFrames: 96, enemyFactor: 0.35, foodFactor: 1.25, dnaFactor: 0.8, cameraZoom: 0.96 },
    ...
    { ...common, n: 6, type: 'growth', target: 3, stars: [3, 3, 3], starMode: 'completionTime', timeStars: [105, 82, 62], timeLimit: 105, finishDelayFrames: 96, startGrowthStage: 1, startingMutations: ['tail'], enemyFactor: 0.75, foodFactor: 1.2, dnaFactor: 1, cameraZoom: 0.9 },
