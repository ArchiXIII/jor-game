(function () {
  ...
  const levels = [
    ...
    { ...common, n: 14, type: 'score', target: 900, stars: [900, 1500, 2200], timeLimit: 120, startGrowthStage: 1, startingMutations: ['tail'], enemyFactor: 0.86, foodFactor: 1, dnaFactor: 0.9, allowAmbush: true, cameraZoom: 0.86 },
    { ...common, n: 15, type: 'growth', target: 3, stars: [3, 3, 3], starMode: 'completionTime', timeStars: [110, 85, 65], timeLimit: 110, finishDelayFrames: 96, startGrowthStage: 1, startingMutations: ['tail'], enemyFactor: 0.92, foodFactor: 1.2, dnaFactor: 1.15, allowAmbush: true, cameraZoom: 0.9 },
    ...
    { ...common, n: 18, type: 'score', target: 1500, stars: [1500, 2600, 3800], timeLimit: 145, startGrowthStage: 1, startingMutations: ['agility'], enemyFactor: 1.04, foodFactor: 1, dnaFactor: 0.95, allowAmbush: true, cameraZoom: 0.82 },
